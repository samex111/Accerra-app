...
export const LAYOUT = {
  ...
  DESKTOP_FILLER_NODES: 220,   // unlabeled density
  ...
  NODE_MIN_RADIUS: 1.5,
  NODE_MAX_RADIUS: 3.5,
  NODE_ILLUMINATED_RADIUS: 5,
  NODE_BASE_OPACITY_MIN: 0.15,
  NODE_BASE_OPACITY_MAX: 0.42,
  NODE_ILLUMINATED_OPACITY: 1.0,

  // Connection distances
  INTRA_CLUSTER_DISTANCE: 80,
